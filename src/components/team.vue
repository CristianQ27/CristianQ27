...
export default {
  data() {
    return {
      teamData: [
        {
          profile: require("@/assets/images/team/1.png"),
          name: "Catojisa S.A.S",
          url: "www.catojisa.com",
        },
        {
          profile: require("@/assets/images/team/4.png"),
          name: "Quality Global Business",
          url: "www.qualitygb.com",
        },
        {
          profile: require("@/assets/images/team/3.png"),
          name: "DRP",
          url: "www.drp.do",
        },
        {
          profile: require("@/assets/images/team/5.png"),
          name: "Wintax",
          url: "IG: @wintaxsrl",
        },
        {
          profile: require("@/assets/images/team/2.png"),
          name: "FiscalconRD",
          url: "IG: @FiscalconRD",
        },
        {
